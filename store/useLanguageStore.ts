...
const translations: Record<Language, Record<string, string>> = {
  'zh-TW': {
    ...
    'flight.date': '查詢日期',
    'flight.search': '查詢航班資訊',
    'flight.searching': '查詢中...',
    'flight.departure': '出發',
    'flight.arrival': '抵達',
    'flight.status': '狀態',
    'flight.onTime': '準時',
    'flight.delayedStatus': '延誤',
    'flight.terminal': '航廈',
    'flight.gate': '登機門',
    'flight.checkIn': '報到櫃檯',
    ...
    'flight.dateWarning': '您選擇的是未來日期（{date}），實時狀態資訊僅顯示當天資料',
    'flight.dateWarningPast': '您選擇的是過去日期（{date}），實時狀態資訊僅顯示當天資料',
    'flight.transportCost': '交通費用',
    'flight.errorNoFlightNumber': '請輸入航班編號',
    'flight.errorQueryFailed': '查詢航班資訊失敗',
    'flight.errorOccurred': '查詢航班資訊時發生錯誤',
