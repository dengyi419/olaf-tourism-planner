      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex items-center gap-6 flex-wrap">
            ...
            <div className="w-12 sm:w-32 md:w-40">
              <div className="flex justify-between text-xs mb-1">
                <span className="whitespace-nowrap hidden sm:inline">預算使用率</span>
                <span className="whitespace-nowrap hidden sm:inline">{budgetPercentage.toFixed(1)}%</span>
                <span className="whitespace-nowrap sm:hidden text-[8px]">{budgetPercentage.toFixed(0)}%</span>
              </div>
